...
public class RestaurantsActivity extends AppCompatActivity implements RestaurantsFragment.ListSelectionListener {
    private FragmentManager manager;
    private FragmentTransaction transaction;
    private WebviewFragmentR webFragment = new WebviewFragmentR();
